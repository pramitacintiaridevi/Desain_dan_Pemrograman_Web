                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <!-- Button Edit -->
                                    <a class="float-right ml-3 text_success" href="update_form.php?mahasiswa_id=<?php echo $dt['id'] ?>" type="button" class="close">
